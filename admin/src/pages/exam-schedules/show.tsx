...
import { format } from "date-fns";
import socket from "../../socket"; // Đảm bảo bạn đã tạo socket client riêng
...
export const ExamScheduleShow: React.FC = () => {
  ...
  // Trạng thái lưu danh sách sinh viên (có thể cập nhật realtime)
  const [students, setStudents] = useState<Student[]>([]);

  // Khởi tạo dữ liệu khi load lần đầu
  useEffect(() => {
  ...
  // Realtime: Lắng nghe student_update từ socket
  useEffect(() => {
    const handleUpdate = (updatedStudent: {
      ...
      setStudents((prevStudents) => {
        ...
        if (index !== -1) {
          ...
          newStudents[index] = {
            ...newStudents[index],
            is_present: updatedStudent.is_present,
            updated_at: updatedStudent.timestamp,
          };
          return newStudents;
        }
